				...
				<div class="footer-container">
					...
					<div class="square-logos">
						<a href="https://www.langcen.cam.ac.uk/culp/culp-index.html"
							...
							<div class="lclogo flex h-14 w-14 items-center justify-center rounded-md border border-white/20 bg-white/5 hover:bg-white/10 transition-colors duration-200">
								${SVG_LC_LOGO}
							</div>
						</a>
					</div>
